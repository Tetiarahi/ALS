...
class EmpWorkStatusController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.empWorkStatuses.index', compact('empWorkStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.empWorkStatuses.create');
    }
    ...
    public function store(StoreEmpWorkStatusRequest $request)
    {
        ...
        return redirect()->route('frontend.emp-work-statuses.index');
    }
    ...
    public function edit(EmpWorkStatus $empWorkStatus)
    {
        ...
        return view('frontend.empWorkStatuses.edit', compact('empWorkStatus'));
    }
    ...
    public function show(EmpWorkStatus $empWorkStatus)
    {
        ...
        return view('frontend.empWorkStatuses.show', compact('empWorkStatus'));
    }
