...
class SpaController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.spas.index', compact('spas'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.spas.create', compact('emp_names'));
    }
    ...
    public function store(StoreSpaRequest $request)
    {
        ...
        return redirect()->route('frontend.spas.index');
    }
    ...
    public function edit(Spa $spa)
    {
        ...
        return view('frontend.spas.edit', compact('emp_names', 'spa'));
    }
    ...
    public function show(Spa $spa)
    {
        ...
        return view('frontend.spas.show', compact('spa'));
    }
