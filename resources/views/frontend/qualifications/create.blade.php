    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.qualifications.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="qua_name">{{ trans('cruds.qualification.fields.qua_name') }}</label>
                            <input class="form-control" type="text" name="qua_name" id="qua_name" value="{{ old('qua_name', '') }}" required>
